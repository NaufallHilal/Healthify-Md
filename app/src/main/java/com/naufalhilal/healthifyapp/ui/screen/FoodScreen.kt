...
fun FoodScreen(navController: NavController, paddingValues: PaddingValues) {
    ...
    // Fetch the food recommendations when the screen is initialized
...
@Composable
fun ExpandableCard(title: String, description: String, status: String, additionalInfo: String) {
    var expanded by remember { mutableStateOf(false) }

    Card(
        colors = CardDefaults.cardColors(
            containerColor = Secondary90,
        ), // This is equivalent to your Surface90 color
        modifier = Modifier
            .fillMaxWidth()
            .padding(16.dp)
